						...
						<ul>
							...
							<li>
								...
								<select name="shr_province" id="">
									...
									<option value="北京">武汉</option>
								</select>

								<select name="shr_city" id="">
									<option value="">请选择</option>
									<option value="朝阳区">朝阳区</option>
									<option value="朝阳区">东城区</option>
									<option value="朝阳区">西城区</option>
									<option value="朝阳区">海淀区</option>
									<option value="朝阳区">昌平区</option>
								</select>

								<select name="shr_area" id="">
									<option value="">请选择</option>
									<option value="西二旗">西二旗</option>
									<option value="西二旗">西三旗</option>
									<option value="西二旗">三环以内</option>
								</select>
							</li>
							<li>
			...
			<div class="goods">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							<td class="col1"><a href=""><?php showImg($v['mid_logo']);?></a>  <strong><a href=""><?php echo $v['goods_name'];?></a></strong></td>
							<td class="col2"> 
							...
							<td class="col5"><span><?php echo $v['price']*$v['goods_number']; $total += $v['price']*$v['goods_number']; ?></span></td>
						</tr>
						<?php endforeach;?>
					</tbody>
					<tfoot>
