		...
		<div class="list_bd fl ml10 mt10">
			...
			<div style="clear:both;"></div>
                        <div >
                            ...
                            <span>
                                品牌：<?php echo ltrim(strchr($brand, '-'), '-');?>
                                <a href="<?php echo filterUrl('brand_id');?>">X</a>
                            </span>
                                  <?php endif; $price = I('get.price'); if($price): ?>
                            <span>
                               价格：<?php echo $price;?>       
                            </span>
                                  <?php endif;?>
			...
			<div class="filter mt10">
                            <h2><a href="<?php echo U('Search/cat_search', '', false);?>/cat_id/<?php echo I('get.cat_id');?>">重置筛选条件</a> <strong>商品筛选</strong></h2>
				<div class="filter_wrap">
					...
					<dl>
						...
						<dd class="cur"><a href="">不限</a></dd>
                                                ...
                                                <dd><a href="/index.php/Home/search/cat_search/cat_id/16/attr_4/%E5%8C%97%E4%BA%AC-%E4%BB%A3%E7%90%86%E5%95%86/odby/addtime/brand_id/<?php echo $v['id'];?>-<?php echo $v['brand_name'];?>"><?php echo $v['brand_name'];?></a></dd>
						<?php endforeach;?>
					</dl>
                                        <?php endif;?>
					...
					<?php if(!I('get.price')):?>
						...
						<dd class="cur"><a href="">不限</a></dd>
                                                ...
                                                <dd><a href="/index.php/Home/search/cat_search/cat_id/16/attr_4/%E5%8C%97%E4%BA%AC-%E4%BB%A3%E7%90%86%E5%95%86/odby/addtime/price/<?php echo $v;?>"><?php echo $v;?></a></dd>
						<?php endforeach;?>
					</dl>
                                        <?php endif;?>

				    <?php foreach($searchFilter['gaData'] as $k => $v): $attrUrlName = 'attr_'.$v[0]['attr_id']; if($_GET[$attrUrlName]) continue; ?>	
                                    <dl>
						<dt><?php echo $k;?>：</dt>
						<dd class="cur"><a href="">不限</a></dd>
                                                <?php foreach($v as $k1 => $v1):?>
                                                <dd><a href="/index.php/Home/search/cat_search/cat_id/16/attr_4/%E5%8C%97%E4%BA%AC-%E4%BB%A3%E7%90%86%E5%95%86/odby/addtime/<?php echo $attrUrlName;?>/<?php echo $v1['attr_value']?>-<?php echo $k;?>"><?php echo $v1['attr_value'];?></a></dd>
                                                <?php endforeach;?>
				...
				<dl>
					<dt>排序：</dt>
                                        ...
                                        <dd <?php if(strpos($odby, 'price_') === 0) echo 'class="cur"';?>><a href="<?php echo filterUrl('odby');?>/odby/<?php echo $odby == 'price_desc' ? 'price_asc' : 'price_desc';?>">
                                                <?php echo $odby == 'price_desc' ? '价格升' : '价格降';?></a></dd>
			...
			<div class="goodslist mt10">
				<ul>
                                    <?php foreach($goodsData['list'] as $k => $v): echo count($goodsData['list']); ?>
					<li>
						<dl>
                                                    <dt><a href="<?php echo U('Index/goods', '', false);?>/goods_id/<?php echo $v['id'];?>"><?php showImg($v['mid_logo']);?></a></dt>
							<dd><a href=""><?php echo $v['goods_name'];?></a></dd>
							<dd><strong>￥<?php echo $v['shop_price'];?></strong></dd>
							<dd><a href=""><em>已有10人评价</em></a></dd>
                                                        <dd><a href="">销量：<em><?php echo $v['x1'];?></em></a></dd>
						</dl>
					</li>	
                                        <?php endforeach;?>
				</ul>
