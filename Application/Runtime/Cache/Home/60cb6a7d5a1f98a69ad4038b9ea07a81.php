				...
				<div class="filter_wrap">
					...
					<dl>
						...
						<dd class="cur"><a href="">不限</a></dd>
                                                ...
                                                <dd><a href="/index.php/Home/search/goods_search/cat_id/17/brand_id/<?php echo $v['id'];?>-<?php echo $v['brand_name'];?>"><?php echo $v['brand_name'];?></a></dd>
						<?php endforeach;?>
					</dl>
                                        <?php endif;?>
					...
					<?php if(!I('get.price')):?>
						...
						<dd class="cur"><a href="">不限</a></dd>
                                                ...
                                                <dd><a href="/index.php/Home/search/goods_search/cat_id/17/price/<?php echo $v;?>"><?php echo $v;?></a></dd>
						<?php endforeach;?>
					</dl>
                                        <?php endif;?>
				    ...
				    <?php foreach($searchFilter['gaData'] as $k => $v): $attrUrlName = 'attr_'.$v[0]['attr_id']; if($_GET[$attrUrlName]) continue; ?>	
						...
						<dd class="cur"><a href="">不限</a></dd>
                                                ...
                                                <dd><a href="/index.php/Home/search/goods_search/cat_id/17/<?php echo $attrUrlName;?>/<?php echo $v1['attr_value']?>-<?php echo $k;?>"><?php echo $v1['attr_value'];?></a></dd>
                                                <?php endforeach;?>
