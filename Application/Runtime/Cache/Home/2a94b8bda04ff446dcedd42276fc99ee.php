			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						...
						<li>
							<dl>
                                                            <dt><a href="<?php echo U('Index/goods?id='.$v['id']);?>"><?php showImg($v['mid_logo']);?> </a></dt>
				...
				<div class="hot none">
					<ul>
                                               <?php foreach($goods_is_hot as $k => $v):?>
						<li>
							<dl>
								<dt><a href="<?php echo U('Index/goods?id='.$v['id']);?>"><?php showImg($v['mid_logo']);?></a></dt>
								<dd><a href="<?php echo U('Index/goods?id='.$v['id']);?>"><?php echo $v['goods_name'];?></a></dd>
				...
				<div class="recommend none">
					<ul>
						 <?php foreach($goods_is_best as $k => $v):?>
						<li>
							<dl>
								<dt><a href="<?php echo U('Index/goods?id='.$v['id']);?>"><?php showImg($v['mid_logo']);?></a></dt>
								<dd><a href="<?php echo U('Index/goods?id='.$v['id']);?>"><?php echo $v['goods_name'];?></a></dd>
				...
				<div class="new none">
					<ul>
						 <?php foreach($goods_is_new as $k => $v):?>
						<li>
							<dl>
								<dt><a href="<?php echo U('Index/goods?id='.$v['id']);?>"><?php showImg($v['mid_logo']);?></a></dt>
								<dd><a href="<?php echo U('Index/goods?id='.$v['id']);?>"><?php echo $v['goods_name'];?></a></dd>
		...
		<div class="floor_left fl">
			...
			<div class="goodslist fl">
				<h2>
                                    ...
                                    <span class="<?php if($k == 0) echo 'on';?>"><?php echo $v1['cat_name'];?></span>
                                    <?php endforeach;?>
				</h2>
					...
					<div>
						<ul>
							<?php foreach($v1['goods'] as $k2 => $v2):?>
                                                        <li>
								<dl>
									<dt><a href=""><?php showImg($v2['mid_logo']);?></a></dt>
				...
				<div class="sidebar_wrap">
					<ul>
						<?php foreach($v['brand'] as $k1 => $v1):?>
                                                <li><a href=""><?php showImg($v1['mid_logo']);?></a></li>
						<?php endforeach;?>
					</ul>
				</div>
			</div>
