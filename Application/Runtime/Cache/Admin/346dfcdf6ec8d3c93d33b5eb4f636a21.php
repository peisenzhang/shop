        ...
        <form enctype="multipart/form-data" action="/index.php/Admin/Goods/add.html" method="post">
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text"  name="promote_price" value="" size="20"/><br/>
                        从<input type="text" id='promote_start_date' name="promote_start_date" value="" size="20"/>
                        到<input type="text" id="promote_end_date" name="promote_end_date" value="" size="20"/>
                        <span class="require-field">*</span>
                    </td>
                </tr>
                <tr>
            ...
            <table style="display: none;" width="90%" id="general-table" align="center">
                <tr>
                    ...
                    <td>
                        ...
                        <p><?php echo $v['level_name'];?><input type="text" name="price[<?php echo $v['id'];?>]" size="20" /></p>
                        <?php endforeach;?>
                    </td>
                </tr> 
            </table>   
