...
<!--    <div id="tabbar-div">
    ...
    <div id="tabbody-div">
        ...
        <form enctype="multipart/form-data" action="/index.php/Admin/Category/edit/id/2.html" method="post">
            <table width="90%" id="general-table" align="center">
                <input type="hidden" value="<?php echo $data['id'];?>" name='id'/>
                <tr>
                    <td class="label">分类名称：</td>
                    <td><input type="text" name="cat_name" value="<?php echo $data['cat_name'];?>"size="30" />
